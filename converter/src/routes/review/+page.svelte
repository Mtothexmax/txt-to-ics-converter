<section style="max-width:1100px; margin:0 auto; font-family:var(--font-sans);">
  ...
  <div style="display:flex; gap:1rem; align-items:center; margin-bottom:1rem;">
    <div>
      ...
      <select id="sort" style="padding:.35rem; border-radius:6px;">
  ...
  <div style="overflow:auto;">
    <table style="width:100%; border-collapse:collapse;">
      <thead style="text-align:left; border-bottom:1px solid var(--color-border);">
        <tr>
          <th style="padding:.5rem">Date</th>
          <th style="padding:.5rem">Start Time</th>
          <th style="padding:.5rem">End Time</th>
          <th style="padding:.5rem">Preview</th>
        </tr>
      </thead>
