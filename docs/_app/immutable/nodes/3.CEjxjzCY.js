import{w as p,a as c,f as u}from"../chunks/JSFGrt-T.js";import"../chunks/CpgaSC3C.js";import{j as t,s as a,k as e,n as l}from"../chunks/vraPIwIq.js";var y=p(u(`<section style="max-width:1100px; margin:0 auto; font-family:var(--font-sans);"><h2 style="margin-top:0;">Review Your Appointments</h2> <div style="display:flex; gap:1rem; align-items:center; margin-bottom:1rem;"><div><label for="sort">Sort:</label> <select id="sort" style="padding:.35rem; border-radius:6px;"><option>Date Ascending</option><option>Date Descending</option></select></div> <div style="margin-left:auto;"><button id="download-top" style="padding:.5rem .75rem; border-radius:6px; background:var(--color-primary); color:var(--color-primary-foreground); border:none; cursor:pointer; display:flex; gap:.5rem; align-items:center;" aria-label="Download ICS"><span class="material-icons" aria-hidden="">download</span>Download ICS File</button></div></div> <div id="no-data" style="color:var(--color-muted-foreground); display:none;">No appointments found. Go back to the <a href="/">landing page</a> to add some.</div> <div style="overflow:auto;"><table style="width:100%; border-collapse:collapse;"><thead style="text-align:left; border-bottom:1px solid var(--color-border);"><tr><th style="padding:.5rem">Date</th><th style="padding:.5rem">Start Time</th><th style="padding:.5rem">End Time</th><th style="padding:.5rem">Preview</th></tr></thead><tbody id="appointments-tbody"></tbody></table></div> <div style="margin-top:1rem;"><button id="download-bottom" style="padding:.5rem .75rem; border-radius:6px; background:var(--color-primary); color:var(--color-primary-foreground); border:none; cursor:pointer; display:flex; gap:.5rem; align-items:center;" aria-label="Download ICS"><span class="material-icons" aria-hidden="">download</span>Download ICS File</button></div> <script>
  ...
  <\/script></section>`));function f(m){var o=y(),d=a(t(o),2),r=t(d),i=a(t(r),2),n=t(i);n.value=n.__value="asc";var s=a(n);s.value=s.__value="desc",e(i),e(r),l(2),e(d),l(8),e(o),c(m,o)}export{f as component};
